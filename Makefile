...
export TERRAFORM_PROVIDER_SOURCE ?= Trozz/pocketid
export TERRAFORM_PROVIDER_REPO ?= https://github.com/Trozz/terraform-provider-pocketid
export TERRAFORM_PROVIDER_VERSION ?= 0.1.2
export TERRAFORM_PROVIDER_DOWNLOAD_NAME ?= terraform-provider-pocketid
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX ?= https://releases.hashicorp.com/$(TERRAFORM_PROVIDER_DOWNLOAD_NAME)/$(TERRAFORM_PROVIDER_VERSION)
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-pocketid_v0.1.2_x5
...
xpkg.build.provider-pocket-id: do.build.images
